...
namespace Examples {
  ...
  public:
    ...
    static void Main() {
      ...
      $<IEnumerable<string>> query1 = fruitClump.Where(delegate_(string fruit) { return fruit.Contains("o");});
      ...
      $<IEnumerable<string>> query2 = fruitClump.AsEnumerable()->Where(delegate_(string fruit) { return fruit.Contains("o");});
