...
namespace SwitchUnitTests {
  ...
  TEST(PropertyWriteOnlyTest, PropertyCopyConstructor) {
    $<PropertyWriteTestClass> p1 = new_<PropertyWriteTestClass>();
    $<PropertyWriteTestClass> p2 = new_<PropertyWriteTestClass>(*p1);
    p2->Name = "Other Value";
    p1 = null;
  ...
  TEST(PropertyWriteOnlyTest, PropertyEqualOperator) {
    $<PropertyWriteTestClass> p1 = new_<PropertyWriteTestClass>();
    $<PropertyWriteTestClass> p2 = new_<PropertyWriteTestClass>();
    *p2 = *p1;
    p2->Name = "Other Value";
    p1 = null;
    ASSERT_EQ("Other Value", p2->name);
