...
namespace SwitchUnitTests {
  ...
  TEST(PropertyTest, PropertyReadOnlyAndCopyConstructor) {
    $<PropertyReadOnly> propertyReadOnly1 = new_<PropertyReadOnly>();
    $<PropertyReadOnly> propertyReadOnly2 = new_<PropertyReadOnly>(*propertyReadOnly1);
  ...
  TEST(PropertyTest, PropertyReadOnlyAndEqualOperator) {
    $<PropertyReadOnly> propertyReadOnly1 = new_<PropertyReadOnly>();
    $<PropertyReadOnly> propertyReadOnly2 = new_<PropertyReadOnly>();
  ...
  TEST(PropertyTest, PropertyWriteOnlyAndCopyConstructor) {
    $<PropertyWriteOnly> propertyWriteOnly1 = new_<PropertyWriteOnly>();
    $<PropertyWriteOnly> propertyWriteOnly2 = new_<PropertyWriteOnly>(*propertyWriteOnly1);
  ...
  TEST(PropertyTest, PropertyWriteOnlyAndEqualOperator) {
    $<PropertyWriteOnly> propertyWriteOnly1 = new_<PropertyWriteOnly>();
    $<PropertyWriteOnly> propertyWriteOnly2 = new_<PropertyWriteOnly>();
  ...
  TEST(PropertyTest, PropertyReadWriteAndCopyConstructor) {
    $<PropertyReadWrite> propertyReadWrite1 = new_<PropertyReadWrite>();
    $<PropertyReadWrite> propertyReadWrite2 = new_<PropertyReadWrite>(*propertyReadWrite1);
  ...
  TEST(PropertyTest, PropertyReadWriteAndEqualOperator) {
    $<PropertyReadWrite> propertyReadWrite1 = new_<PropertyReadWrite>();
    $<PropertyReadWrite> propertyReadWrite2 = new_<PropertyReadWrite>();
