...
namespace EncodingUT {
  ...
  void GetByteCountTest($<System::Text::Encoding> encoding, int charByteSize, int piByteSize, int sigmaByteSize, int koalaByteSize);
  void GetBytesTest($<System::Text::Encoding>, int, int, int, int, const string&, const string&, const string&, const string&);
