    ...
    namespace Windows {
      ...
      namespace Forms {
        ...
        public:
          ...
          static System::Windows::Forms::DialogResult Show(const IWin32Window& owner, const string& message) {return MessageBox::Show(owner, message, "", MessageBoxButtons::OK, MessageBoxIcon::None, MessageBoxDefaultButton::Button1, (MessageBoxOptions)0, "");}
