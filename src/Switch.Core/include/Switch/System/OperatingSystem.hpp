...
namespace Switch {
  ...
  namespace System {
    ...
    public:
      ...
      property_<String, readonly_> ServicePack {
        get_ {
      ...
      property_<const System::Version&, readonly_> Version {
        get_->const System::Version& {return this->version;}
      };
      ...
      property_<String, readonly_> VersionString {
        get_ {
