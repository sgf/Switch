...
namespace Switch {
  ...
  namespace System {
    ...
    /// @par Library
    /// Switch.Core
    struct core_export_ Int32 final : public ValueType, public IComparable, public IConvertible, public IFormattable {
    public:
      ...
      /// @cond
      bool Equals(const Int32& value) const {return this->value == value;}
