/// @file
/// @brief Contains Switch::System::Text::UnicodeEncoding class.
#pragma once
...
namespace Switch {
  ...
  namespace System {
    ...
    namespace Text {
      ...
      /// @par Library
      /// Switch.Core
      class core_export_ UnicodeEncoding : public Encoding {
      public:
        ...
        $<Decoder> CreateDecoder() const override;
        $<Encoder> CreateEncoder() const override;
