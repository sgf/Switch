/// @file
/// @brief Contains Switch::System::Char struct.
#pragma once
...
namespace Switch {
  ...
  namespace System {
    ...
    /// @par Library
    /// Switch.Core
    struct core_export_ Char final : public ValueType, public IComparable, public IConvertible {
    public:
