...
namespace Switch {
  ...
  namespace System {
    ...
    /// @par Library
    /// Switch.Core
    struct core_export_ UInt64 final : public ValueType, public IComparable, public IConvertible, public IFormattable {
    public:
      ...
      /// @cond
      bool Equals(const UInt64& value) const {return this->value == value;}
