  ...
  namespace TUnit {
    namespace Framework {
      ...
      struct TestAttribute {
        ...
        template<typename TestFixture>
        TestAttribute(const string& name, TestFixture& testFixture, void (TestFixture::*method)(), const System::Runtime::CompilerServices::Caller& caller) : TestAttribute(name, testFixture, method, TestState::Considered, caller_) {}
